    ...
    <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <section className="hidden lg:flex flex-col justify-between bg-dark-900 text-light-100 p-10">
        <div className="flex items-center">
          <div className="h-12 w-12 rounded-md bg-orange inline-flex items-center justify-center">
            <Image
  src={logo}// ✅ use a root-relative path for public assets
  alt="Nike"
  width={20}
  height={20}
  className="h-5 w-auto" // ✅ ensures aspect ratio remains correct
/>
          </div>
        </div>
